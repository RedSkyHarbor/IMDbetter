                ...
                {this.state.data.map(d =>
                    <div className={styles.movie} key={d.id}>
                        ...
                        <div className={styles.movie_details}>
                            ...
                            <p className={styles.rating}><i style={{color: 'gold'}} class="fas fa-star"></i>{d.avg_rating ? ` Average rating: ${d.avg_rating.toString().subtr(0,3)} out of 10` : ' No user reviews yet'}</p>
